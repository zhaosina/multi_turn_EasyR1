...
- **MetaSpatial**: Reinforcing 3D Spatial Reasoning in VLMs for the Metaverse. [![[code]](https://img.shields.io/github/stars/dvlab-research/MetaSpatial)](https://github.com/PzySeere/MetaSpatial)
